  ...
  return (
    ...
    >
      <div className="max-w-4xl w-full mx-auto flex flex-col items-center text-center gap-8">
        ...
        >
          <h1
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-white leading-none"
          >
            Yashasvi Udayan
          </h1>
        ...
        >
          <a href="https://www.linkedin.com/in/yashasvi-udayan/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-[#A1A1A1] hover:text-white transition-colors duration-200">
          ...
          <button
            ...
            className="relative text-[#A1A1A1] hover:text-white transition-colors duration-200 focus:outline-none"
          >
